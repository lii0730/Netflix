...
class ContentCollectionViewMainCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        [imageView, descriptionLabel, contentStackView].forEach {
            // StackView에 넣을때는 addArrangedSubview를 사용한다.
        ...
        categoryButton.addTarget(self, action: #selector(catrgoryButtonTapped), for: .touchUpInside)
    ...
    @objc func catrgoryButtonTapped(sender: UIButton!) {
